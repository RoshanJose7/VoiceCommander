...
__all__ = [ 'OLE_YSIZE_HIMETRIC', 'IPictureDisp', 'IFontDisp',
           'Picture', 'LoadPictureConstants', 'OLE_OPTEXCLUSIVE',
           ...
           'OLE_XSIZE_CONTAINER', 'FONTSIZE', 'Color', 'FONTBOLD',
           'OLE_TRISTATE', 'Checked', 'OLE_XPOS_PIXELS', 'Gray',
           'OLE_YPOS_PIXELS', 'Monochrome', 'OLE_COLOR', 'FONTNAME',
           'FONTSTRIKETHROUGH', 'IFont', 'Unchecked',
           'OLE_XPOS_HIMETRIC', 'VgaColor', 'Font', 'FONTUNDERSCORE',
           'StdPicture', 'OLE_YPOS_CONTAINER', 'FONTITALIC',
           'OLE_YPOS_HIMETRIC', 'StdFont', 'OLE_CANCELBOOL',
